                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="button-content">
                            ...
                            <a
                                class="btn btn-lg"
                                href="<?=$base?>/admin/permissions/newItem"
                            >Adicionar</a>
                        </div>
                    </div>
                    <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: end;">
                                            <a
                                                ...
                                                href="<?=$base?>/admin/permissions/edit/item/<?=Store::aesEncrypt($item["id"])?>"
                                            >Editar</a>
                                            <a
                                                onclick="return confirm('Você tem certeza que deseja excluir?')"
                                                class="btn btn-sm btn-del"
                                                href="<?=$base?>/admin/permissions/del/item/<?=Store::aesEncrypt($item["id"])?>"
                                            >Excluir</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
